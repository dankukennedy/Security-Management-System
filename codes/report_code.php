...
if(isset($_POST['send_report']))
{
    ...
    if($result)
    { redirect(" <h4 style='color:green; font:200'>Report Added Successfully</h4>","report.php");


    }
     else
     {
        redirect(" <h4 style='color:red; font:200'>Something Went Wrong Report Not Created</h4>","report.php");
