...
if(isset($_POST['deleteProof']))
{
    ...
    if($result)
    {
        redirect("<h4 style='color:red;' > CIC Picture Deleted Successfully  !!!</h4>","viewProof.php");

    }
    else
    {
        redirect("<h4 style='color: orange;' >Something Went Wrong</h4>","viewProof.php");
    }
                        ...
                        if($commentNotEmpty)
                        {
                            ...
                            if ( $emailNotEmpty)
                            {
                                ...
                                if($fileNotEmpty)
                                {
                                    ...
                                    {
                                        move_uploaded_file($fileTmpName,$fileDestination);
                                        redirect("<h4 style='color: green;' > File Uploaded Successfully  !!!</h4>","viewProof.php");
                                    }
                                    else
                                    {
