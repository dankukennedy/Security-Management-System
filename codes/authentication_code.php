...
if(isset($_POST['register']))
{
    ...
    if($checkConfirmPassword)
    {
                      ...
                      if($regimentalNoEmpty)
                      {
                        ...
                        if($regimentalNoLenght){
                           ...
                           if(!$regimentalNoCheck)
                           {
                                                    ...
                                                    if($passwordHash)
                                                     {
                                                      ...
                                                      {
                                                        redirect("<h4 style='color: orange;'>Check your SubDivision/District/Municipal/Metro cannot be left empty!!!</h4>","register.php");
                                     
                                                    }
                                                }else
                                                {
                                                    redirect("<h4 style='color: orange;'>Check your Region cannot be left empty!!!</h4>","register.php");
                                     
                                                }
                                            }
                                            else{
                                                redirect("<h4 style='color: orange;'>Check your Gender cannot be left empty!!!</h4>","register.php");
                                    
                                            }
                                        }else{
                                            redirect("<h4 style='color: orange;'>Check your Rank cannot be left empty!!!</h4>","register.php");
                            ...
                            redirect("<h4 style='color: orange;'>Regimental Number already Existed !!!</h4>","register.php");
                           }
                        }
                        else{
                            redirect("<h4 style='color: orange;'>Regimental Number must be 6 to 8 digits !!!</h4>","register.php");
                        }
                      } 
                      else{
                        redirect("<h4 style='color: orange;'>Regimental Number Field cannot be Empty !!!</h4>","register.php");
                      }
                   }
                         else{
                            redirect("<h4 style='color: orange;'>NIA already Existed !!!</h4>","register.php");
                         }
                } else
                {
                    redirect("<h4 style='color: orange;'>NIA Field cannot be Empty !!!</h4>","register.php");
                }
            }  else 
                {
       ...
       {  redirect("<h4 style='color: orange;'>Names Fields cannot be left empty !!!</h4>","register.php");
